<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("t_AccountData");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid t_AccountData");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: RegistrationProcess.EnterUserDataTask
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">t_AccountData</label>
                            		<div class="div_texbox">
                              		<input name="t_AccountData" type="text" class="textbox" id="t_AccountData" value="${t_AccountData}" />
                            		</div>
