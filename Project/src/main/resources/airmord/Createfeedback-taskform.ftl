<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("t_Feedback");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid t_Feedback");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: Feedback process.Createfeedback
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">t_Feedback</label>
                            		<div class="div_texbox">
                              		<input name="t_Feedback" type="text" class="textbox" id="t_Feedback" value="${t_Feedback}" />
                            		</div>
